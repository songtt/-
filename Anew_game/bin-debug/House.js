...
var House = (function (_super) {
    ...
    House.prototype.onAddToStage = function (event) {
        ...
        this.socketRes = this._bg.addtxt({ "text": 222222, "color": "0x610C1e", "x": 0, "y": 0, "size": 22 });
        this.addChild(this.socketRes);
        //连接websocket
        this.web_socket = Connection.webSocket;
        var obj = { do: "add", userId: egret.localStorage.getItem("userId"), coust: "all" };
        var cmd = JSON.stringify(obj);
        this.web_socket.writeUTF(cmd);
        //得到返回值
        this.msgH = Connection.msg;
    };
    // 点击地图
